...
<div>
    <?php if ($nextTour):?>
        <a class="btn btn-success"  href="<?php echo \yii\helpers\Url::to(['/quest-team/new-tour', 'id' => $nextTour->id])?>">К следующему туру</a>
    <?php else:?>
        <a class="btn btn-success" href="<?php echo \yii\helpers\Url::to(['/quest-team/game-stat'])?>">К игровой статистике</a>
    <?php endif;?>
</div>
